...
GLOBAL(bool) jpeg_start_decompress (j_decompress_ptr cinfo)
{
...
LOCAL(bool) output_pass_setup (j_decompress_ptr cinfo)
{
...
GLOBAL(bool) jpeg_start_output (j_decompress_ptr cinfo, int scan_number)
{
...
GLOBAL(bool) jpeg_finish_output (j_decompress_ptr cinfo)
{
  if ((cinfo->global_state == DSTATE_SCANNING ||
